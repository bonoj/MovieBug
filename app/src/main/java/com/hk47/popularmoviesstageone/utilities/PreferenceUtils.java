package com.hk47.popularmoviesstageone.utilities;
...
public class PreferenceUtils {
    ...
    public static void setStartupCheck(Context context, boolean isStartup) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
        editor.putBoolean(context.getString(R.string.pref_startup_check_key), isStartup);
        editor.apply();
    }

    public static boolean getStartupCheck(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String startupCheckKey = context.getString(R.string.pref_startup_check_key);
    ...
    public static void setTabletPortraitBackPress(Context context, boolean isTabletPortraitBackPressed) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
        editor.putBoolean(context.getString(R.string.pref_tablet_portrait_back_press_key), isTabletPortraitBackPressed);
        editor.apply();
    }

    public static boolean getTabletPortraitBackPress(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String tabletPortraitBackPressKey = context.getString(R.string.pref_tablet_portrait_back_press_key);
