...
import me.bonoj.moviebug.utilities.MoviesJsonUtils;
import me.bonoj.moviebug.utilities.PreferenceUtils;
import me.bonoj.moviebug.utilities.QueryBuilderUtils;
...
public class MovieListFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(me.bonoj.moviebug.R.layout.fragment_movie_list, container, false);
        mActivity = getActivity();
        mIsDualPane = getResources().getBoolean(me.bonoj.moviebug.R.bool.is_dual_pane);
        mSortOrder = PreferenceUtils.getSortOrder(mActivity);
        mProgressBar = (ProgressBar) rootView.findViewById(me.bonoj.moviebug.R.id.loading_indicator);
        mErrorTextView = (TextView) rootView.findViewById(me.bonoj.moviebug.R.id.error_text_view);
        mRecyclerView = (RecyclerView) rootView.findViewById(me.bonoj.moviebug.R.id.movie_recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mGridLayoutManager = new GridLayoutManager(mActivity, getResources().getInteger(me.bonoj.moviebug.R.integer.grid_columns));
                ...
                public void onVolleyError(String message) {
                    if (message != null) {
                       ...
                       if (message.equals(MoviesJsonUtils.CONNECTION_ERROR_CASE)) {
                           message = getString(me.bonoj.moviebug.R.string.connection_error);
                       } else if (message.equals(MoviesJsonUtils.SERVER_ERROR_CASE)) {
                           message = getString(me.bonoj.moviebug.R.string.server_error);
                       } else {
                           message = getString(me.bonoj.moviebug.R.string.parsing_error);
                       }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        inflater.inflate(me.bonoj.moviebug.R.menu.menu, menu);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case me.bonoj.moviebug.R.id.menu_most_popular:
                Toast.makeText(mActivity, getString(me.bonoj.moviebug.R.string.most_popular_toast), Toast.LENGTH_SHORT).show();
                ...
                getNextPageFromApi(1);
                return true;
            case me.bonoj.moviebug.R.id.menu_top_rated:
                Toast.makeText(mActivity, getString(me.bonoj.moviebug.R.string.top_rated_toast), Toast.LENGTH_SHORT).show();
                ...
                getNextPageFromApi(1);
                return true;
            case me.bonoj.moviebug.R.id.menu_favorites:
                Toast.makeText(mActivity, getString(me.bonoj.moviebug.R.string.favorites_toast), Toast.LENGTH_SHORT).show();
                if (mSortOrder.equals(FAVORITES_FLAG)) {
                    return false;
                }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (mCursorAdapter.getItemCount() == 0) {
            ...
            mErrorTextView.setVisibility(View.VISIBLE);
            mErrorTextView.setText(getString(me.bonoj.moviebug.R.string.no_favorites));
        }
    }
